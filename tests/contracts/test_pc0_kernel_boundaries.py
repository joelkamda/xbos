...
class PC0KernelBoundaryTests(unittest.TestCase):
    ...
    def _finance_contracts() -> tuple[dict, dict, tuple[str, ...]]:
        ...
        return baseline, inventory, (pc1["accepted_head"], pc2["accepted_head"], pc3["accepted_head"], pc4["accepted_head"], pc5["accepted_head"], so1["accepted_head"], so2["accepted_head"], so3["accepted_head"], so4["accepted_head"], so5["accepted_head"])
